...
response(error, {Method, Controller, Action}, Req, Opts, State) ->
  {ok, Req1} = cowboy_req:reply(200,[],<<"you are not authorized to access the api">>, Req),
  {ok, Req1, State};
response(ok, {<<"OPTIONS">>, Controller, Action}, Req, Opts, State) ->
...
%%% Params : Req/term, Controller/binary, Action/binary
%%% Return : ModuleName/atom
%%%==========================================================================================================
